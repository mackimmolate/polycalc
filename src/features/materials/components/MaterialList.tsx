...
const rowGridClass =
  'grid gap-3 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.3fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,3.6fr)]';
...
export function MaterialList({ materials, sort, onSortChange }: MaterialListProps) {
  return (
